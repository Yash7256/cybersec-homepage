...
function ScanGrid() {
  return (
    ...
    >
      <defs>
        <pattern id="pg-scan-grid" width="40" height="40" patternUnits="userSpaceOnUse">
          <path
            d="M 40 0 L 0 0 0 40"
            fill="none"
      ...
      <rect width="100%" height="100%" fill="url(#pg-scan-grid)" mask="url(#pg-grid-mask)" />
  ...
  return (
    ...
    >
      ...
      {[
        ...
        <circle key={i} cx={cx} cy={cy} r={i === 0 ? 5 : 3.5} fill="oklch(0.7 0.18 295)" />
      ))}
    </svg>
  );
}
      ...
      <div className="relative mx-auto max-w-[1100px]">
        ...
        <div ref={headRef} className="mb-12">
          ...
          <p className="font-body mt-4 max-w-[480px] text-[14px] leading-relaxed text-muted-foreground">
            Run the security checks you need without adding another complicated workflow. Start
            free, then scale when your team needs more.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-[62fr_38fr]">
          ...
          <div
            ref={freeRef}
            className="group relative overflow-hidden rounded-2xl border border-border/60 bg-card p-8 transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 md:p-10"
            style={{
            ...
            <div className="relative z-10 flex h-full flex-col gap-6">
              ...
              <div>
                ...
                <p className="font-body mt-4 max-w-[380px] text-[14px] leading-relaxed text-muted-foreground">
                  Get started with CyberSec Toolkit and see your security posture in minutes — no
                  setup, no complexity.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {["Port Scanner", "Subdomain Enum", "SSL Check", "WHOIS", "GeoIP", "AI Report"].map(
                  (tag) => (
                    <span
                      key={tag}
          ...
          <div
            ref={teamRef}
            className="group relative overflow-hidden rounded-2xl border border-border/50 bg-[#0d0618]/80 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-border/80 md:p-8"
            style={{
            ...
            <div className="relative z-10 flex h-full flex-col gap-5">
              ...
              <div>
                ...
                <p className="font-body mt-4 text-[13px] leading-relaxed text-muted-foreground">
                  Shared access, collaboration, and security workflows built for teams that need
                  more visibility.
                </p>
              </div>
              ...
              <div className="space-y-1.5">
                {["Shared scan workspace", "Team-level reporting", "Priority support"].map(
                  (item) => (

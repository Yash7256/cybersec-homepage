...
function Docs() {
  ...
  return (
    ...
    >
      <div
        className="my-6 rounded-lg border border-[#f97316]/30 bg-[#f97316]/10 p-4"
        id="responsible-use"
      >
        <h2 className="text-2xl font-semibold text-[#f97316] font-mono mb-2">
      ...
      <ol className="space-y-3 text-sm text-[#ffffff] list-decimal list-inside mb-6">
        <li>
      ...
      <ul className="space-y-3 text-sm text-[#ffffff] mb-6">
        <li className="flex items-start gap-3">
          <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-[#ba9cff]" />
          <span>
      ...
      <div className="my-6 rounded-lg border border-[#f97316]/30 bg-[#f97316]/10 p-4">
      ...
      <div className="overflow-x-auto mb-6">
        <table className="w-full text-sm text-sm text-[#ffffff]">
          <thead>
            <tr className="border-b border-white/10">
              <th className="text-left py-3 px-4 font-semibold text-[#ffffff]">Tool</th>
              <th className="text-left py-3 px-4 font-semibold text-[#ffffff]">What you type in</th>
              <th className="text-left py-3 px-4 font-semibold text-[#ffffff]">Best for</th>
            </tr>
          </thead>
          <tbody>
      ...
      <div className="space-y-6 mb-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-[#ffffff] list-disc list-inside ml-4">
            <li>
